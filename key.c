...
//permutation tale for changing 64 bit key to 56 bit.
int permutekey__table[8][7] = {{57 , 49 , 41 , 33 , 25 , 17 , 9 },
                               { 1 , 58 , 50 , 42 , 34 , 26 , 18},
                               {10 ,  2 , 59 , 51 , 43 , 35 , 27},
                               {19 , 11 ,  3 , 60 , 52 , 44 , 36},
...
//permutation table for sub keys.
int permutesubkey_table[8][6] ={{14 , 17 , 11 , 24 ,  1 , 5 },
                                { 3 , 28 , 15 ,  6 , 21 , 10},
                                {23 , 19 , 12 ,  4 , 26 , 8 },
                                {16 ,  7 , 27 , 20 , 13 , 2 },
                                {41 , 52 , 31 , 37 , 47 , 55},
